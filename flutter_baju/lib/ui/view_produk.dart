...
import 'package:flutter_baju/ui/detail_produk.dart';
...
class ProdukView extends StatelessWidget {
  ...
  void setDetail(BuildContext context,id, merk, deskripsi, harga,warna)async {
    ...
    Navigator.pushReplacement(
        ...
        MaterialPageRoute(
            builder: (BuildContext context) =>
                detail_produk_view(id:id, warna: warna,deskripsi:warna,
